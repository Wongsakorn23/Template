...
class TestTest4():
  ...
  def test(self):
    with allure.step("Open URL"):
      self.driver.get("https://www.susco.co.th/webcasts.asp")
    try:
      #self.driver.get("https://demo.irplus.in.th/Listed/susco/webcasts.asp")
      ...
      if (len(self.driver.window_handles) == 2):
        ...
        time.sleep(1)
        text = self.driver.find_element(By.CSS_SELECTOR, ".text-center").text
        assert text != "\\\"\\\""
        text = self.driver.find_element(By.XPATH, "//*[@id=\"my-video\"]").text
        assert text != "The media could not be loaded, either because the server or network failed or because the format is not supported."
        time.sleep(1)
        self.driver.close()
      pass
